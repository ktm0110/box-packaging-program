...
이 두 박스를 모두 담을 수 있는 **가장 작은 포장 박스**를 계산하는 프로그램이다.
본 프로젝트는 **포인터, 동적 메모리 할당, 배열, 3차원 구조 이해**를 목표로 한다.
...
[![Video Label](http://img.youtube.com/vi/cKpNziEF3Dw/0.jpg)](https://youtu.be/cKpNziEF3Dw)
